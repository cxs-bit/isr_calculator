    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("section", { id: "#heading" },
            React.createElement(AbsoluteCenter, null,
                React.createElement(Box, { p: "25px", h: "80vh", w: "80vw", display: "flex", flexDir: "column", backgroundColor: "bg.muted", borderRadius: "lg", borderWidth: "1px", borderColor: "gray.700", spaceY: 2 },
